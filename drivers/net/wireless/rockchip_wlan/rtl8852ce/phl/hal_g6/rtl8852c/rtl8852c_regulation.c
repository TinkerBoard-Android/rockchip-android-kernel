...
#define REGULATION_CHPLAN_VERSION_8852C 64
#define REGULATION_COUNTRY_VERSION_8852C 41
...
static const struct country_domain_mapping cdmap_8852c[] = {
    ...
    {0x5e, 0x00, {'A', 'Z'}, TPO_NA, 0x0f, 0, 0x00, 0}, /* 0051 */
    ...
    {0x5e, 0x00, {'Z', 'A'}, TPO_NA, 0x0f, 0, 0x00, 1}, /* 0080 */
    {0x5e, 0x06, {'T', 'R'}, TPO_NA, 0x0f, 0, 0x01, 1}, /* 0081 */
    {0x0a, 0x00, {'U', 'A'}, TPO_UKRAINE, 0x0f, 0, 0x00, 0}, /* 0082 */
    ...
    {0x0a, 0x00, {'T', 'H'}, TPO_NA, 0x0f, 0, 0x00, 0}, /* 0099 */
    ...
    {0x0a, 0x05, {'A', 'G'}, TPO_NA, 0x0f, 0, 0x01, 0}, /* 0117 */
    ...
    {0x0a, 0x00, {'B', 'Z'}, TPO_NA, 0x0f, 0, 0x00, 1}, /* 0123 */
    ...
    {0x0a, 0x00, {'D', 'M'}, TPO_NA, 0x0f, 0, 0x00, 1}, /* 0148 */
    ...
    {0x0a, 0x00, {'G', 'D'}, TPO_NA, 0x0f, 0, 0x00, 0}, /* 0163 */
    ...
    {0x0a, 0x00, {'G', 'Y'}, TPO_NA, 0x0f, 0, 0x00, 0}, /* 0169 */
    ...
    {0x0a, 0x06, {'L', 'A'}, TPO_NA, 0x0f, 0, 0x01, 1}, /* 0176 */
    {0x5e, 0x00, {'L', 'R'}, TPO_NA, 0x0f, 0, 0x00, 1}, /* 0177 */
    {0x0a, 0x00, {'L', 'Y'}, TPO_NA, 0x0f, 0, 0x00, 0}, /* 0178 */
    ...
    {0x0a, 0x06, {'M', 'N'}, TPO_NA, 0x0f, 0, 0x01, 0}, /* 0191 */
    ...
    {0x0a, 0x00, {'K', 'N'}, TPO_NA, 0x0f, 0, 0x00, 1}, /* 0204 */
    {0x0a, 0x00, {'L', 'C'}, TPO_NA, 0x0f, 0, 0x00, 0}, /* 0205 */
    {0x76, 0x00, {'M', 'F'}, TPO_NA, 0x0f, 0, 0x00, 1}, /* 0206 */
    {0x76, 0x00, {'S', 'X'}, TPO_NA, 0x0f, 0, 0x00, 1}, /* 0207 */
    {0x5e, 0x00, {'P', 'M'}, TPO_NA, 0x0f, 0, 0x00, 1}, /* 0208 */
    {0x0a, 0x00, {'V', 'C'}, TPO_NA, 0x0f, 0, 0x00, 0}, /* 0209 */
    {0x0a, 0x00, {'W', 'S'}, TPO_NA, 0x0f, 0, 0x00, 0}, /* 0210 */
    ...
    {0x0a, 0x00, {'S', 'B'}, TPO_NA, 0x0f, 0, 0x00, 0}, /* 0215 */
    {0x0a, 0x00, {'S', 'O'}, TPO_NA, 0x0f, 0, 0x00, 0}, /* 0216 */
    ...
    {0x0a, 0x00, {'T', 'O'}, TPO_NA, 0x0f, 0, 0x00, 0}, /* 0225 */
    {0x3a, 0x00, {'T', 'M'}, TPO_NA, 0x0f, 0, 0x00, 0}, /* 0226 */
    {0x0a, 0x00, {'T', 'C'}, TPO_NA, 0x0f, 0, 0x00, 0}, /* 0227 */
    ...
    {0x0a, 0x00, {'I', 'R'}, TPO_NA, 0x01, 0, 0x00, 0}, /* 0236 */
