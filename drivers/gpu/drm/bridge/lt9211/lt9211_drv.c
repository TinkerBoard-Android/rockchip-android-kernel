			   ...
			   struct lt9211_data *data)
{
	...
	//data->lt9211_en_gpio = devm_gpiod_get_optional(dev, "EN",  GPIOD_OUT_HIGH); //uboot-kernel
	...
	//data->lvds_vdd_en_gpio = devm_gpiod_get_optional(dev, "lvds_vdd_en", GPIOD_OUT_HIGH);//uboot-kernel
	...
	//data->pwr_source_gpio = devm_gpiod_get_optional(dev, "pwr_source", GPIOD_OUT_HIGH);//uboot-kernel
