...
void lt9211_pattern(struct lt9211_data *lt9211)
{
	...
	if(pclk_khz < 44000) {
		...
		pr_info("lt9211_pattern: pclk_khz >= 352000\n");
		lt9211_write(lt9211->client, 0x35, 0x80);
		dessc_pll_post_div = 0;
	}
...
EXPORT_SYMBOL_GPL(lt9211_bridge_enable);
...
EXPORT_SYMBOL_GPL(lt9211_bridge_disable);
...
EXPORT_SYMBOL_GPL(lt9211_loader_protect);
...
static void lt9211_remove(struct i2c_client *i2c)
{
