...
static void ilitek_touch_driver_remove(struct spi_device *spi)
{
	ilitek_main_remove(spi);
}
#else
...
static void ilitek_touch_driver_remove(struct i2c_client *client)
{
	ilitek_main_remove(client);
}
#endif
