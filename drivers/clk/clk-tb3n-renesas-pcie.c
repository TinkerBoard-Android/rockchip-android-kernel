...
struct tb3n_rs9_chip_info {
	const enum tb3n_rs9_model	model;
	unsigned int		num_clks;
};

static int tb3n_rs9_probe(struct i2c_client *client)
{
	int  ret;
...
static const struct tb3n_rs9_chip_info tb3n_renesas_9fgv0441_info = {
	.model		= RENESAS_9FGV0441,
	.num_clks	= 4,
};

static const struct i2c_device_id tb3n_rs9_id[] = {
	{ "9fgv0441tb3n", .driver_data = RENESAS_9FGV0441 },
	{ }
};
MODULE_DEVICE_TABLE(i2c, tb3n_rs9_id);

static const struct of_device_id tb3n_clk_rs9_of_match[] = {
	{ .compatible = "renesas,9fgv0441tb3n", .data = &tb3n_renesas_9fgv0441_info },
	{ }
};
MODULE_DEVICE_TABLE(of, tb3n_clk_rs9_of_match);

static struct i2c_driver tb3n_rs9_driver = {
	.driver = {
		.name = "clk-renesas-pcie-9series",
		.of_match_table = tb3n_clk_rs9_of_match,
	},
	.probe_new	= tb3n_rs9_probe,
	.shutdown       = tb3n_rs9_shutdown,
	.id_table	= tb3n_rs9_id,
};
module_i2c_driver(tb3n_rs9_driver);

MODULE_AUTHOR("Yi-Hsin Hung <yi-hsin_hung@asus.com>");
MODULE_DESCRIPTION("Renesas 9-series PCIe clock generator driver for ASUS TB3N");
MODULE_LICENSE("GPL");
